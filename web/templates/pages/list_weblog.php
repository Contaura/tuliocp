...
<head>
	...
	<?php require $_SERVER["TULIO"] . "/web/templates/includes/title.php"; ?>
	<?php require $_SERVER["TULIO"] . "/web/templates/includes/css.php"; ?>
	<?php require $_SERVER["TULIO"] . "/web/templates/includes/js.php"; ?>
</head>
				...
				<div class="container top-bar-inner">
					<div class="top-bar-left">
						<a href="/" class="top-bar-logo" title="<?= htmlentities($_SESSION['APP_NAME']);?>">
							<img src="<?php if ( !empty($_SESSION['LOGO_HEADER'])){ echo $_SESSION['LOGO_HEADER']; } else{ echo "/images/logo-tulio-header.svg"; } ?>" alt="<?= htmlentities($_SESSION['APP_NAME']);?>" width="54" height="29">
						</a>
					</div>
