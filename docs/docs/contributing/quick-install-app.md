...
More information can be found in the [hestia-quick-install repo](https://github.com/contaura/hestia-quick-install/blob/main/Example/ExampleSetup.php)
...
3. Copy the [example file's content](https://github.com/contaura/hestia-quick-install/blob/main/Example/ExampleSetup.php) into your new file.
