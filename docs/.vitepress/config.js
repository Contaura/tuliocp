...
export default defineConfig({
	...
	themeConfig: {
		...
		editLink: {
			pattern: 'https://github.com/contaura/tuliocp/edit/main/docs/:path',
	...
	return [
		...
		{ text: 'Donate', link: '/donate' },
		{
			...
			items: [
				{
					text: 'Changelog',
					link: 'https://github.com/contaura/tuliocp/blob/main/CHANGELOG.md',
				},
				{
					text: 'Contributing',
					link: 'https://github.com/contaura/tuliocp/blob/main/CONTRIBUTING.md',
				},
				{
					text: 'Security policy',
					link: 'https://github.com/contaura/tuliocp/blob/main/SECURITY.md',
				},
			],
		},
	];
